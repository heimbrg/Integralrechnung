\chapter{Anwendungen der Integralrechnung}


\section{Volumen}

Bisher haben wir die Integralrechnung benutzt um Flächen berechnen zu können. In einigen Beispielen lassen sich damit jedoch auch Volumen berechnen.


\subsection{Die Schichten-Methode}
